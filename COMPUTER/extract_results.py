...
for file in files:
    ...
    if extension == ".csv":
            ...
            for configuration in valConfiguration:
                for screen in valScreen:
                    ...
                    if flag == True:
                        ...
                        print(msg1)
                        print(msg2)
                        if screen == valScreen[0]:
                            msg = fileId + ',' + orientation + ',' + configuration + ',' + str(int(area1)) + ',' + str(int(area2))
                            message = message + msg
                        elif screen == valScreen[1]:
                            msg = ',' + str(int(area1)) + ',' + str(int(area2)) + '\n'
                            message = message + msg
        ...
        filePath = "./DataExtract/FinalAreaResults.csv"
